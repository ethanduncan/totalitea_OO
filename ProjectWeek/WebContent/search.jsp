	...
	<div class="container">
		...
		<div class="large box">
		    <form action="ControllingServlet" method="get" align="center">
		        ...
		        <input type="text" name="searchText" class="form-control text" placeholder="Search for an item in our collection of fine teas" id="search"> <br />
		        <div class="row">
		            <div class="col-lg-3 col-lg-offset-2">
		                <p style="margin-top: 13px !important;"><b>Search by name</b></p>
		            </div><!-- /.col-lg-3 -->
		            <div class="col-lg-1">
		                <input type="radio" id="searchtype" name="searchType" value="name" checked>
		            </div><!-- /.col-lg-1 -->
		            <div class="col-lg-3 col-lg-offset-1">
		                <p style="margin-top: 13px !important;"><b>Search by category</b></p>
		            </div><!-- /.col-lg-3 -->
		            <div class="col-lg-1">
		                <input type="radio" id="searchtype" name="searchType" value="category">
		            </div><!-- /.col-lg-1 -->
		        </div><!-- /.row -->
		        <button type="submit" class="base-button" id="search">Search</button>
		        <br /><br />
		    </form>
		</div>
